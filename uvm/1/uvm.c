...
void op_peek(void)   { int a = fetch(); T1("peek", a); push(peek(a)); }
void op_poke(void)   { int a = fetch(); T1("poke", a); poke(a, pop()); }
void op_ipeek(void)  { int a = fetch(); T1("ipeek", a); a += pop(); push(peek(a)); }
void op_ipoke(void)  { int a = fetch(); T1("ipoke", a); a += pop(); poke(a, pop()); }
